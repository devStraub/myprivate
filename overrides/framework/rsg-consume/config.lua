...
return {
    ...
    AlcoholEffects = {
        ...
        DrunkNotification = {
            title = locale('consume.drunk_title'),
            description = locale('consume.drunk_description'),
            type = 'inform',
            duration = 3000,
            position = 'top-right'
        },
        PassOutNotification = {
            title = locale('consume.unwell_title'),
            description = locale('consume.unwell_description'),
            type = 'error',
            duration = 5000,
            position = 'top-right'
        },
        WakeUpNotification = {
            title = locale('consume.wakeup_title'),
            description = locale('consume.wakeup_description'),
            type = 'inform',
            duration = 5000,
            position = 'top-right'
        },
        SoberNotification = {
            title = locale('consume.recovered_title'),
            description = locale('consume.recovered_description'),
            type = 'success',
            duration = 2000,
            position = 'top-right'
        }
