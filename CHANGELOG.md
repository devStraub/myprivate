...
agents:
  - provider: openai
    ...
    date: 2026-08-23
sources: []
related: [governance/knowledge-lifecycle.md]
visibility: private
---

# Changelog

Alterações relevantes da estrutura e das políticas. A evolução detalhada de conteúdo permanece no histórico Git.

## Não publicado — v0.1

### Adicionado

- Fundação portátil da Developer Toolbox.
