---
id: curriculum-ai-ml-foundations
title: 18 — AI & Machine Learning Foundations
...
# 18 — AI & Machine Learning Foundations

## Objetivo

Entender os fundamentos necessários para avaliar e integrar sistemas de Machine Learning sem fingir formação de pesquisador.

## Tópicos alvo

- supervised e unsupervised learning;
- classification, regression e clustering;
- training e inference;
- features e datasets;
- overfitting e underfitting;
- bias/variance;
- evaluation metrics;
- neural networks, activations e layers;
- embeddings;
- transformers e attention;
- training vs inference em modelos neurais;

## Projeto público sugerido

`lab-machine-learning-foundations`
...
- resolve problema pequeno com ML;
- separa treino e avaliação;
- usa métrica adequada ao problema;
- documenta limitações/dataset/bias quando relevantes;
- não usa acurácia isolada quando insuficiente;
- explica o que o modelo aprendeu e o que não pode ser inferido;
