---
id: curriculum-frontend-engineering-hci
title: 17 — Frontend Engineering & HCI
...
# 17 — Frontend Engineering & HCI

## Objetivo

Tratar frontend como engenharia da plataforma Web e interação humana, não apenas uso de framework.

## Tópicos alvo

- HTML, CSS e JavaScript;
- DOM e browser rendering;
- event loop, storage e network;
- accessibility;
- TypeScript: generics, inference, narrowing e utility types;
- component architecture;
- state management e server state;
- routing, forms e validation;
- frontend testing;
- performance e Core Web Vitals;
- responsive interfaces;
- HCI: usability, feedback, consistency, affordances, cognitive load e user-centered design;

## Projeto público sugerido

`lab-frontend-engineering`
...
- aplicação React/TypeScript ou equivalente demonstra arquitetura clara;
- inclui acessibilidade verificável;
- mede ao menos um aspecto de performance Web;
- possui testes relevantes;
- explica decisões de estado/server-state;
- documenta um pequeno fluxo de HCI/usabilidade;
...
- MIT 6-3: HCI and graphics;
- Stanford HCI track;
- Stanford CS core + aplicações;
