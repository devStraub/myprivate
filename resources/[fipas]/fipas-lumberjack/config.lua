...
Config.ActionDuration = 7000
Config.CooldownSeconds = 90
Config.MinimumServerDuration = 5000
Config.ToolBreakChance = 4
Config.SkillCheck = { 'easy', 'easy', 'medium' }

Config.BlockedTowns = {
    Annesburg = true, Armadillo = true, Blackwater = true, Lagras = true,
    Rhodes = true, StDenis = true, Strawberry = true, Tumbleweed = true,
    Valentine = true, Vanhorn = true,
}

Config.Rewards = {
    { name = 'wood',   label = 'Madeira macia', weight = 30, min = 2, max = 5 },
    { name = 'hwood',  label = 'Madeira dura',  weight = 18, min = 1, max = 3 },
    { name = 'sap',    label = 'Seiva',         weight = 12, min = 1, max = 2 },
    { name = 'fibers', label = 'Fibras',        weight = 16, min = 1, max = 4 },
    { name = 'pulp',   label = 'Polpa de madeira', weight = 15, min = 1, max = 3 },
    { name = 'rubber', label = 'Latex natural', weight = 6, min = 1, max = 2 },
    { name = 'honey',  label = 'Mel silvestre', weight = 3, min = 1, max = 1 },
}

Config.Items = {
    wood   = { label = 'Madeira macia', weight = 300, image = 'axe.png', description = 'Madeira leve recem-cortada.' },
    hwood  = { label = 'Madeira dura', weight = 450, image = 'axe.png', description = 'Madeira densa para construcoes resistentes.' },
    sap    = { label = 'Seiva', weight = 100, image = 'axe.png', description = 'Seiva extraida de uma arvore.' },
    fibers = { label = 'Fibras vegetais', weight = 80, image = 'axe.png', description = 'Fibras resistentes retiradas da casca.' },
    pulp   = { label = 'Polpa de madeira', weight = 180, image = 'axe.png', description = 'Material fibroso para processamento.' },
    rubber = { label = 'Latex natural', weight = 120, image = 'axe.png', description = 'Latex bruto extraido de arvore.' },
    honey  = { label = 'Mel silvestre', weight = 150, image = 'axe.png', description = 'Mel encontrado em colmeias silvestres.' },
}
